...
using WeatherService.Testing.XUnit.Integration.Core.FirstResponderKit;
using WeatherService.Testing.XUnit.Integration.Core.Infrastructure.Database;
using WeatherService.Testing.XUnit.Integration.Seeding.Fakers;

namespace WeatherService.Testing.XUnit.Integration.Seeding.Features.GetAuditLogsTests;

/// <summary>
/// <see cref="InstallFirstResponderKit"/>
/// </summary>
[Trait("DB", "LongRunning")]
public sealed class When_a_lot_of_data_is_stored_in_the_database
    : TestSpecification
{
    ...
    public void Should_not_have_missing_indexes()
    {
        ...
        // Above call will fail with this message
        Assert.Fail("""
